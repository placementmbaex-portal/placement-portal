      ...
      <div className="mt-6 space-y-4 border-t border-rule pt-6">
        ...
        <form action={confirmAction} className="flex flex-wrap items-center gap-4">
          ...
          <button
            ...
            className="flex h-11 items-center rounded-md bg-navy px-4 text-[15px] font-medium text-white hover:bg-navy/90 disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:h-10"
          >
            {confirmPending
              ? "Marking…"
